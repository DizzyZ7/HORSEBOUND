...
redistribute, rebrand, sell, or publish the project or its original content.

HORSEBOUND uses libGDX and LWJGL as third-party runtime/framework components.
Those projects are governed by their own licenses and are not claimed as original
work by the HORSEBOUND creator.
