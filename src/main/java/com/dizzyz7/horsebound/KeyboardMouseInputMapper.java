...
/**
 * Current desktop adapter. Gameplay systems consume PlayerCommand rather than libGDX key codes.
 */
final class KeyboardMouseInputMapper implements InputMapper {
    ...
    public InputSnapshot sample() {
        float forward = axis(Input.Keys.W, Input.Keys.S);
        float right = axis(Input.Keys.D, Input.Keys.A);
